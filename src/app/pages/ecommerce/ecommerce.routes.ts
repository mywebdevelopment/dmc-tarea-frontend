...
import {  LisProductsEcommerceComponent } from './list-productos-ecommerce/list-productos-ecommerce.component';
...
export default [
    ...
    { path: 'ecommerce', data: { breadcrumb: 'Menu' }, component: LisProductsEcommerceComponent },
    { path: 'basket', data: { breadcrumb: 'Menu' }, component: BasketComponent },
