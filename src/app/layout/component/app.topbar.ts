...
import { ApiCartService } from '../../pages/service/api-cart.service';
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, IconField, InputIcon, MenubarModule, OverlayBadgeModule],
          ...
          <button class="layout-topbar-menu-button layout-topbar-action" 
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">                 
                    ...
                    <p-overlaybadge value="{{totalItemsCart}}" severity="danger" [routerLink]="['/ecommerce/basket']" >
...
export class AppTopbar implements OnInit {
    ...
    constructor(private apiCartService: ApiCartService, public layoutService: LayoutService) {}
    ngOnInit() {
        this.apiCartService.cartItems$.subscribe(items => {
            console.log('AppTopbar. Items en el carrito:', items);
            this.totalItemsCart = this.apiCartService.getItemsCount() | 0;
          });
    }
    toggleDarkMode() {
